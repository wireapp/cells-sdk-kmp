...
enum class IdmWorkspaceScope(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is IdmWorkspaceScope) "$data" else null

        /**
         * Returns a valid [IdmWorkspaceScope] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): IdmWorkspaceScope? = data?.let {
